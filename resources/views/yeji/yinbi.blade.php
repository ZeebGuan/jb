...
<div id="main">
    <div class="email">
        ...
        <div class="info-nav">
            ...
            <a href="{{URL('licai-yinbi')}}" class="tuijian-hover">银币天使转换</a>
        </div>
        <form class="form" action="{{URL('do/yinbilicai')}}" method="post">
            <div class="info-content">
                ...
                <div class="info-content-table"  style="background: #fff;">
                    <table width="855" border="0" align="center" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="320" align="right">创益银币：</td>
                            <td><input type="text" class="input" name="fushu" value="{{$yinbi}}" readonly/></td>
                        </tr>
                        <tr>
                            <td align="right">天使资本：</td>
                            <td><input type="text" class="input" name="licai" value="{{$qianbao}}" readonly/></td>
                        </tr>
                        <tr>
                            <td align="right">转换数量：</td>
                            <td><input type="text" class="input" name="jine" value="" datatype="n" nullmsg="请输入转换数量！" errormsg="请输入10的倍数！" ajaxurl="{{URL('checkyinbilicai')}}" /> </td>
                        </tr>
                        <tr>
                            <td align="right" style="padding: 0px;"></td>
                            <td align="left" style="padding: 0px;"><font color="#ff0000">* 银币转换天使资本比例1:50</font> </td>
                        </tr>
                        <tr>
