...
<div id="main">
    <div class="email">
        ...
        <div class="info-nav">
            <a href="{{URL('licai-zhuanhuan')}}" class="index-hover">负数钱包转换</a>
        ...
        <form class="form" action="{{URL('do/licaizhuanhuan')}}" method="post">
            <div class="info-content">
                ...
                <div class="info-content-table"  style="background: #fff;">
                    <table width="855" border="0" align="center" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="320" align="right">负数钱包：</td>
                            <td><input type="text" class="input" name="fushu" value="{{$fushu}}" readonly/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="input" name="jine" value="" datatype="n" nullmsg="请输入100的倍数！" errormsg="请输入100的倍数！" ajaxurl="{{URL('checklicai')}}" /> </td>
                        </tr>
                        <tr>
