...
<div id="main">
    <div class="email">
        ...
        <form class="form" action="{{URL('do/duihuanchuangyibi')}}" method="post">
            ...
            <div class="info-content" style="padding-bottom:30px;">
                <div class="info-content-table" style="background:#fff;">
                    <table width="855" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td align="right">明日钱包：</td>
                            <td><input type="text" class="input" name="user" value="{{$mingriqianbao}}" readonly /></td>
                        </tr>
                        <tr>
                            <td align="right">兑换金币数量：</td>
                            <td><input type="text" class="input" name="num" value="1" datatype="n" nullmsg="请输入兑换数量" ajaxurl="{{URL('checkmingri')}}" />
                            </td>
                        </tr>
