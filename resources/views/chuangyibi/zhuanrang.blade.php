...
<div id="main">
    <div class="email">
        <div class="e-location"><a href="javascript:history.go(-1)">返回</a> / <a href="main">首页</a> / <a>匹配中心</a> / 创益币转让记录</div>
        <div class="info-nav">
            <a href="{{URL('chuangyibi')}}" class="index">转让创益币</a>
            <a href="{{URL('chuangyibi-zhuanrang')}}" class="guanli-hover">转让记录</a>
            <a href="{{URL('chuangyibi-jieshou')}}" class="pwd">接收记录</a>

            <a href="{{URL('chuangyibi-duihuanjilu')}}" class="tuijian">金币兑换记录</a>
        </div>
        <div class="e-content">
