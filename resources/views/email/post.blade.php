...
<div id="main">
    <div class="email">
        <div class="e-location"><a href="javascript:history.go(-1)">返回</a> / <a href="{{URL('main')}}">首页</a> / <a>邮件中心</a> / 发件箱</div>
        <div class="e-nav">
            <a href="{{URL('email')}}" class="shou">收件箱</a>
            <a href="{{URL('email-post')}}" class="fa-hover">发件箱</a>
                ...
                <table width="887" style="margin-top:20px; text-align:center; line-height:36px;" align="center" border="0" cellspacing="0" cellpadding="0">
                    ...
                    @foreach($email as $e)
                        <tr onmousemove=style.backgroundColor='#e8edf1' onmouseout=style.backgroundColor='#FFFFFF'>
                            ...
                            <td> <a href="{{URL('email-detal')}}/fa/{{$e->id}}">查看</a>  | <a href="{{URL('do/delemail')}}/{{$e->id}}" onclick='javascript:return del()'>删除</a> </td>
                        </tr>
                    @endforeach
