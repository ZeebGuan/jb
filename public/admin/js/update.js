...
function challs_flash_update(){ //Flash 初始化函数
    ...
    //a.typefile = ["Upload (*.gif,*.png,*.jpg,*jpeg,*.flv,*.swf,*.mp3,*.mp4,*.wav,*.wma,*.wmv,*.avi,*.mpg,*.asf,*.rm,*.rmvb)","*.gif;*.png;*.jpg;*.jpeg;*.flv;*.swf;*.mp3;*.mp4;*.wav;*.wma;*.wmv;*.avi;*.mpg;*.asf;*.rm;*.rmvb;",];
    a.typefile = ["Upload (*.gif,*.png,*.jpg,*jpeg)","*.gif;*.png;*.jpg;*.jpeg;",];
    //设置可以上传文件 数组类型
    //"Images (*.gif,*.png,*.jpg)"为用户选择要上载的文件时可以看到的描述字符串,
    //"*.gif;*.png;*.jpg"为文件扩展名列表，其中列出用户选择要上载的文件时可以看到的 Windows 文件格式，以分号相隔
    //2个为一组，可以设置多组文件类型

    //a.newTypeFile = ["Upload (*.gif,*.png,*.jpg,*jpeg,*.flv,*.swf,*.mp3,*.mp4,*.wav,*.wma,*.wmv,*.avi,*.mpg,*.asf,*.rm,*.rmvb)","*.gif;*.png;*.jpg;*.jpeg;*.flv;*.swf;*.mp3;*.mp4;*.wav;*.wma;*.wmv;*.avi;*.mpg;*.asf;*.rm;*.rmvb;","JPE;JPEG;JPG;GIF;PNG;FLV;SWF;MP3;MP4;WAV;WMA;WMV;AVI;MPG;ASF;RM;RMVB",];
    a.newTypeFile = ["Upload (*.gif,*.png,*.jpg,*jpeg)","*.gif;*.png;*.jpg;*.jpeg;","JPE;JPEG;JPG;GIF;PNG",];
...
function challs_flash_onCompleteData(a){ //获取服务器反馈信息事件
    a=a.replace(/\s+/g,"");
    document.getElementById('pic').value+=a;
